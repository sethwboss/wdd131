...
let query = 'an';   // this will be the value of the search box in th recipe homework, use search = input or something
...
let filteredHikes = hikes.filter(function(hike) {
    ...
    hike.tags.find((tag) => tag.toLowerCase().toLowerCase().includes(hikeQuery.toLowerCase()))
